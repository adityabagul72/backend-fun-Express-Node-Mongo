...
function Navbar() {
  const navItems = (
    <>
      ...
      <li className='font-semibold'><a href='/course'>Course</a></li>
        ...
        <div className="navbar bg-white border-b-[1px] border-gray-200">
          <div className="navbar-start">
            <div className="dropdown">
              <div tabIndex={0} role="button" className="btn border border-gray-300 mr-4 btn-ghost lg:hidden">
                <svg
            ...
            <a className="text-xl font-bold cursor-pointer md:px-9 px-2">bookStore</a>
          </div>
          <div className='navbar-end'>
            ...
            {/* dark light button ends  */}
            <div className="md:px-9 px-2">
              <a className="btn bg-black text-white rounded-xl" onClick={()=> document.getElementById("my_modal_3").showModal()}>
              Login
              </a>
              <Login/>
              </div>
